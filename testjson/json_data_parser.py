...
#03.31.2019 currently tracing through script and providing overview on how to modify code for intel drone
...
#specify input file in input file path
INPUT_FILE = "./intelData/10Mar1-01.json"
#INPUT_FILE2 = "./intelData/10Mar2-01.json"
#INPUT_FILE = "./data/encrypted_parrot_partial.json"

#function to ignore duplicates                               ***I dont actually know what this does
...
#reads json file by decoding files for python analysis with load()
def read_json(input_file):
    with open(input_file) as i:
        return json.load(i, object_pairs_hook=dict_ignore_on_duplicates)


#defines packet class
class Packet(object):

    def __init__(self, packet):
	#look for the frame breakdown of packet
	#fields need to be tailored toward the intel header breakdown fields in json file
        try:
	...
	#locate packets with invalid information and notify the user
        except KeyError, e:
            self._packet_size = 0
            self._time_stamp = 0
            self._time_delta = 0
